  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Web Design & Development',style: TextStyle(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: Image(image: AssetImage("assets/image/Web Design and Development 1.png"),height: 217,width: 217,)),
            SizedBox(height: 20,),
