...
class Counstration extends StatelessWidget {
  const Counstration({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Consultration',style: TextStyle(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(child: Image(image: AssetImage("assets/image/consultation 1.png"),height: 217,width: 217,)),
            SizedBox(height: 20,),
