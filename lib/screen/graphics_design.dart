...
class GraphicsDesign extends StatelessWidget {
  const GraphicsDesign({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Graphics Design',style: TextStyle(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(child: Image(image: AssetImage("assets/image/Graphics_designer 1.png"),height: 217,width: 217,)),
            SizedBox(height: 20,),
